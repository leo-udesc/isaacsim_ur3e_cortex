...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from isaacsim.replicator.examples.ogn.OgnSampleOnSphereDatabase import OgnSampleOnSphereDatabase
        ...
        test_node = og.Controller.node("/TestGraph/Template_isaacsim_replicator_examples_OgnSampleOnSphere")
