...
.. _ext_isaacsim_robot_setup_grasp_editor:
...
[isaacsim.robot_setup.grasp_editor] Grasp Editor
################################################
...
.. tab-set::
    .. tab-item:: Command-line interface
        ...
        .. code-block:: bash
            ...
            APP_SCRIPT.(sh|bat) --enable isaacsim.robot_setup.grasp_editor
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.robot_setup.grasp_editor``.
