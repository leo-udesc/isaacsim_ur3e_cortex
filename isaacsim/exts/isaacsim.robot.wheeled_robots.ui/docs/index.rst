...
.. _ext_isaacsim_robot_wheeled_robots_ui:
...
.. tab-set::
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.robot.wheeled_robots.ui``.
