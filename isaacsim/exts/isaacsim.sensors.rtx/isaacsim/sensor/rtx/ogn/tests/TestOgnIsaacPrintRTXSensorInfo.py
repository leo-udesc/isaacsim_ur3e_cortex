...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from isaacsim.sensors.rtx.ogn.OgnIsaacPrintRTXSensorInfoDatabase import OgnIsaacPrintRTXSensorInfoDatabase
        ...
        test_node = og.Controller.node("/TestGraph/Template_isaacsim_sensors_rtx_IsaacPrintRTXSensorInfo")
