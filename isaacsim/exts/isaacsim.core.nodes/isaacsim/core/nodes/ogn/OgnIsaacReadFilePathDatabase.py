...
class OgnIsaacReadFilePathDatabase(og.Database):
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.core.nodes.IsaacReadFilePath'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnIsaacReadFilePathDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                icon_path = icon_path + '/' + "ogn/icons/isaacsim.core.nodes.IsaacReadFilePath.svg"
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.core.nodes.IsaacReadFilePath")
