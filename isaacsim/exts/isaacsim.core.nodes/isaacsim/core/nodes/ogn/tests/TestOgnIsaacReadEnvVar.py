...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from isaacsim.core.nodes.ogn.OgnIsaacReadEnvVarDatabase import OgnIsaacReadEnvVarDatabase
        ...
        test_node = og.Controller.node("/TestGraph/Template_isaacsim_core_nodes_IsaacReadEnvVar")
