...
class OgnIsaacReadEnvVarDatabase(og.Database):
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.core.nodes.IsaacReadEnvVar'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnIsaacReadEnvVarDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                icon_path = icon_path + '/' + "ogn/icons/isaacsim.core.nodes.IsaacReadEnvVar.svg"
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.core.nodes.IsaacReadEnvVar")
