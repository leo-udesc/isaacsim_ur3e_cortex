"""Support for simplified access to data on nodes of type isaacsim.core.nodes.IsaacCreateViewport
...
class OgnIsaacCreateViewportDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.core.nodes.IsaacCreateViewport
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.core.nodes.IsaacCreateViewport'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnIsaacCreateViewportDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                icon_path = icon_path + '/' + "ogn/icons/isaacsim.core.nodes.IsaacCreateViewport.svg"
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.core.nodes.IsaacCreateViewport")
