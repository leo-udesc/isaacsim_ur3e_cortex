"""Support for simplified access to data on nodes of type isaacsim.core.nodes.IsaacArticulationState
...
class OgnIsaacArticulationStateDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.core.nodes.IsaacArticulationState
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.core.nodes.IsaacArticulationState'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnIsaacArticulationStateDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.core.nodes.IsaacArticulationState")
