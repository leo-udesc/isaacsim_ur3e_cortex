"""Support for simplified access to data on nodes of type isaacsim.core.nodes.IsaacCreateRenderProduct
...
class OgnIsaacCreateRenderProductDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.core.nodes.IsaacCreateRenderProduct
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.core.nodes.IsaacCreateRenderProduct'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnIsaacCreateRenderProductDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                icon_path = icon_path + '/' + "ogn/icons/isaacsim.core.nodes.IsaacCreateRenderProduct.svg"
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.core.nodes.IsaacCreateRenderProduct")
