"""Support for simplified access to data on nodes of type isaacsim.core.nodes.IsaacGetViewportRenderProduct
...
class OgnIsaacGetViewportRenderProductDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.core.nodes.IsaacGetViewportRenderProduct
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.core.nodes.IsaacGetViewportRenderProduct'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnIsaacGetViewportRenderProductDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                icon_path = icon_path + '/' + "ogn/icons/isaacsim.core.nodes.IsaacGetViewportRenderProduct.svg"
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.core.nodes.IsaacGetViewportRenderProduct")
