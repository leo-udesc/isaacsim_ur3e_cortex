"""Support for simplified access to data on nodes of type isaacsim.core.nodes.IsaacArticulationController
...
class OgnIsaacArticulationControllerDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.core.nodes.IsaacArticulationController
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.core.nodes.IsaacArticulationController'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnIsaacArticulationControllerDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.core.nodes.IsaacArticulationController")
