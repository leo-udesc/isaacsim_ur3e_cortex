...
.. _ext_isaacsim_robot_setup_xrdf_editor:
...
[isaacsim.robot_setup.xrdf_editor] Robot Description Editor
###########################################################
...
.. tab-set::
    .. tab-item:: Command-line interface
        ...
        .. code-block:: bash
            ...
            APP_SCRIPT.(sh|bat) --enable isaacsim.robot_setup.xrdf_editor
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.robot_setup.xrdf_editor``.
