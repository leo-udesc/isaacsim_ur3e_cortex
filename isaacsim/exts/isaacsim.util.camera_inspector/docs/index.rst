...
.. _ext_isaacsim_util_camera_inspector:
...
[isaacsim.util.camera_inspector] Camera Inspector
#################################################
...
.. tab-set::
    .. tab-item:: Command-line interface
        ...
        .. code-block:: bash
            ...
            APP_SCRIPT.(sh|bat) --enable isaacsim.util.camera_inspector
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.util.camera_inspector``.
