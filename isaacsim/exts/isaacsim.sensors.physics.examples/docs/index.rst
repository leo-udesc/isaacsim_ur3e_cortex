...
.. _ext_isaacsim_sensors_physics_examples:
...
[isaacsim.sensors.physics.examples] Isaac Sim Physics Sensor Simulation Examples
################################################################################
...
.. tab-set::
    .. tab-item:: Command-line interface
        ...
        .. code-block:: bash
            ...
            APP_SCRIPT.(sh|bat) --enable isaacsim.sensors.physics.examples
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.sensors.physics.examples``.
