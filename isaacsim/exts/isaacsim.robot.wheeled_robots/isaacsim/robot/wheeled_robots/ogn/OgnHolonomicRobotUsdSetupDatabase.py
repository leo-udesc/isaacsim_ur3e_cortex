...
class OgnHolonomicRobotUsdSetupDatabase(og.Database):
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.robot.wheeled_robots.HolonomicRobotUsdSetup'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnHolonomicRobotUsdSetupDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.robot.wheeled_robots.HolonomicRobotUsdSetup")
