...
class OgnAckermannDatabase(og.Database):
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.robot.wheeled_robots.AckermannSteering'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnAckermannDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.robot.wheeled_robots.AckermannSteering")
