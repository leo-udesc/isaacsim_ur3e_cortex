"""Support for simplified access to data on nodes of type isaacsim.robot.wheeled_robots.QuinticPathPlanner
...
class OgnQuinticPathPlannerDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.robot.wheeled_robots.QuinticPathPlanner
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.robot.wheeled_robots.QuinticPathPlanner'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnQuinticPathPlannerDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.robot.wheeled_robots.QuinticPathPlanner")
