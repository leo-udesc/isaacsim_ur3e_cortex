"""Support for simplified access to data on nodes of type isaacsim.robot.wheeled_robots.HolonomicController
...
class OgnHolonomicControllerDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.robot.wheeled_robots.HolonomicController
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.robot.wheeled_robots.HolonomicController'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnHolonomicControllerDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.robot.wheeled_robots.HolonomicController")
