"""Support for simplified access to data on nodes of type isaacsim.robot.wheeled_robots.CheckGoal2D
...
class OgnCheckGoal2DDatabase(og.Database):
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.robot.wheeled_robots.CheckGoal2D'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnCheckGoal2DDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.robot.wheeled_robots.CheckGoal2D")
