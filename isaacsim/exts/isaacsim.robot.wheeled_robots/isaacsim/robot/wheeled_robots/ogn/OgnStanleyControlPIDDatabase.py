"""Support for simplified access to data on nodes of type isaacsim.robot.wheeled_robots.StanleyControlPID
...
class OgnStanleyControlPIDDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.robot.wheeled_robots.StanleyControlPID
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.robot.wheeled_robots.StanleyControlPID'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnStanleyControlPIDDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.robot.wheeled_robots.StanleyControlPID")
