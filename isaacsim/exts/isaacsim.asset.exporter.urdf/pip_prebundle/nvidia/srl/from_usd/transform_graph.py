...
class TransformNode:
    ...
    def __init__(
        ...
        self._to_global_transform: Optional[np.ndarray] = (
    ...
    @property
    def to_global_transform(self) -> Optional[np.ndarray]:
        """Return the to global transform."""
        return self._to_global_transform
...
class TransformGraph(SRL):
    ...
    def _update_joint_node(self, joint_prim: Usd.Prim) -> None:
        ...
        # and child links
        global___parent_link = parent_link_node.to_global_transform
        ...
        global___child_link = child_link_node.to_global_transform
        ...
        joint_node._to_global_transform = global___joint_via_parent_no_scale
