...
class Inertial(UrdfXmlElement):
    ...
    origin: Pose = field(default=Pose(), metadata={"type": "element"})
    mass: Mass = field(default=Mass(), metadata={"type": "element"})
    inertia: Inertia = field(default=Inertia(), metadata={"type": "element"})
