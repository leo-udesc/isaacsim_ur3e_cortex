"""Support for simplified access to data on nodes of type isaacsim.replicator.domain_randomization.OgnWritePhysicsSimulationContext
...
class OgnWritePhysicsSimulationContextDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.replicator.domain_randomization.OgnWritePhysicsSimulationContext
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.replicator.domain_randomization.OgnWritePhysicsSimulationContext'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnWritePhysicsSimulationContextDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.replicator.domain_randomization.OgnWritePhysicsSimulationContext")
