"""Support for simplified access to data on nodes of type isaacsim.replicator.domain_randomization.OgnWritePhysicsArticulationView
...
class OgnWritePhysicsArticulationViewDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.replicator.domain_randomization.OgnWritePhysicsArticulationView
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.replicator.domain_randomization.OgnWritePhysicsArticulationView'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnWritePhysicsArticulationViewDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.replicator.domain_randomization.OgnWritePhysicsArticulationView")
