...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from isaacsim.replicator.domain_randomization.ogn.OgnCountIndicesDatabase import OgnCountIndicesDatabase
        ...
        test_node = og.Controller.node("/TestGraph/Template_isaacsim_replicator_domain_randomization_OgnCountIndices")
