...
class OgnWritePhysicsRigidPrimViewDatabase(og.Database):
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.replicator.domain_randomization.OgnWritePhysicsRigidPrimView'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnWritePhysicsRigidPrimViewDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.replicator.domain_randomization.OgnWritePhysicsRigidPrimView")
