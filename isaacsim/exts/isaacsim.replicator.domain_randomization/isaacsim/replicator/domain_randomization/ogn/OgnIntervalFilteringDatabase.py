...
class OgnIntervalFilteringDatabase(og.Database):
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.replicator.domain_randomization.OgnIntervalFiltering'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnIntervalFilteringDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.replicator.domain_randomization.OgnIntervalFiltering")
