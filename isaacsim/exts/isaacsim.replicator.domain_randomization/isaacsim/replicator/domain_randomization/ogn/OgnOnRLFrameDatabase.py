"""Support for simplified access to data on nodes of type isaacsim.replicator.domain_randomization.OgnOnRLFrame
...
class OgnOnRLFrameDatabase(og.Database):
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.replicator.domain_randomization.OgnOnRLFrame'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnOnRLFrameDatabase.abi.initialize(context, n)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.replicator.domain_randomization.OgnOnRLFrame")
