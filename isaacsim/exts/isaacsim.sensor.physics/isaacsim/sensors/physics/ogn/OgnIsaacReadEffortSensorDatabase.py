...
class OgnIsaacReadEffortSensorDatabase(og.Database):
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.sensors.physics.IsaacReadEffortSensor'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnIsaacReadEffortSensorDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                node_type.set_metadata(ogn.MetadataKeys.EXTENSION, "isaacsim.sensors.physics")
                ...
                icon_path = carb.tokens.get_tokens_interface().resolve("${isaacsim.sensors.physics}")
                icon_path = icon_path + '/' + "ogn/icons/isaacsim.sensors.physics.IsaacReadEffortSensor.svg"
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.sensors.physics.IsaacReadEffortSensor")
