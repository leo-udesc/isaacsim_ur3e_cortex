...
.. _ext_isaacsim_util_clash_detection:
...
[isaacsim.util.clash_detection] Isaac Sim Clash Detection
#########################################################
...
Mesh Collision Detection Utility
...
.. tab-set::
    .. tab-item:: Command-line interface
        ...
        .. code-block:: bash
            ...
            APP_SCRIPT.(sh|bat) --enable isaacsim.util.clash_detection
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.util.clash_detection``.
