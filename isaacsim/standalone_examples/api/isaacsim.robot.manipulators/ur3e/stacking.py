...
from isaacsim.robot.manipulators.examples.ur3e.controllers.stacking_controller import StackingController
from isaacsim.robot.manipulators.examples.ur3e.tasks import Stacking
...
my_controller = StackingController(
    ...
    gripper=my_ur3e.gripper,
    robot_articulation=my_ur3e,
