...
class OgnIsaacGripperControllerDatabase(og.Database):
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.robot.manipulators.IsaacGripperController'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnIsaacGripperControllerDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                node_type.set_metadata(ogn.MetadataKeys.EXTENSION, "isaacsim.robot.manipulators")
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.robot.manipulators.IsaacGripperController")
